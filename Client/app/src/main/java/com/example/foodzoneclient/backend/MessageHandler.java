...
import com.example.foodzoneclient.protocols.InfoResponse;
import com.example.foodzoneclient.protocols.ServerMessage;
import com.example.foodzoneclient.protocols.orderResponse;
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (serverMessage.getOpcode() == 1) {
            ...
            if (infoResponse.getReCode() == 0 || infoResponse.getReCode() == 3) {
                ...
                SharedPreferences prefs = FoodZone.getContext().getSharedPreferences("user_info", Context.MODE_PRIVATE);
            ...
            Message response = Message.obtain(ChangePasswordActivity.changePasswordhandler);
            response.what = 3;
